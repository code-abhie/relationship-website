const config = {
  ...
  */
  ...
  // 🔐 Passcode Page
  correctPasscode: "2002", // Change this to any 4-digit code (the passcode for access)
  ...
  // ⏳ Timer Page
  anniversaryDate: "2025-05-20", // 📅 Set your anniversary date here (used for the timer)
